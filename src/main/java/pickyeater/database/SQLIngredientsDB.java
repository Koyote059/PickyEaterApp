...
public class SQLIngredientsDB implements IngredientsDatabase {
    ...
    public void saveIngredient(Ingredient ingredient) {
        try {
            if (DBChecker.isWordIllegal(ingredient.getName()))
                throw new SQLException("Illegal name: " + ingredient.getName());
    ...
    public Optional<Ingredient> loadIngredient(String ingredientName) {
        try {
            if (DBChecker.isWordIllegal(ingredientName))
                throw new SQLException("Illegal name: " + ingredientName);
